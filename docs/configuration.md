...
* [`firstLower` string suffix](https://godoc.org/github.com/huandu/xstrings#FirstRuneToLower)
* [`firstUpper` string suffix](https://godoc.org/github.com/huandu/xstrings#FirstRuneToUpper)
