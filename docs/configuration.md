...
| `cpuprofile`                                           | :fontawesome-solid-x:     | `#!yaml ""`                           | When set, mockery writes a CPU profile of the run to the given file path. Useful for diagnosing slow generation. Leave empty to disable profiling.                                                                                                     |
