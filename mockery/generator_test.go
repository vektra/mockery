...
func (s *GeneratorSuite) getGenerator(
	filepath, interfaceName string, inPackage bool, mockLibPath string,
) *Generator {
	return NewGenerator(s.getInterfaceFromFile(filepath, interfaceName), pkg, inPackage, mockLibPath)
}

func (s *GeneratorSuite) checkGeneration(
	filepath, interfaceName string, inPackage bool, expected string,
) *Generator {
	generator := s.getGenerator(filepath, interfaceName, inPackage, "github.com/stretchr/testify/mock")
...
func (s *GeneratorSuite) TestTestifyGeneratorPrologue() {
	generator := s.getGenerator(testFile, "Requester", false, "github.com/stretchr/testify/mock")
...
func (s *GeneratorSuite) TestGoMockGeneratorPrologue() {
	generator := s.getGenerator(testFile, "Requester", false, "github.com/maraino/go-mock")
	expected := `package mocks
...
func (s *GeneratorSuite) TestTestifyGeneratorPrologueWithImports() {
	generator := s.getGenerator("requester_ns.go", "RequesterNS", false, "github.com/stretchr/testify/mock")
	expected := `package mocks
...
func (s *GeneratorSuite) TestGoMockGeneratorPrologueWithImports() {
	generator := s.getGenerator("requester_ns.go", "RequesterNS", false, "github.com/maraino/go-mock")
	expected := `package mocks
...
func (s *GeneratorSuite) TestTestifyGeneratorPrologueWithMultipleImportsSameName() {
	generator := s.getGenerator("same_name_imports.go", "Example", false, "github.com/stretchr/testify/mock")
...
func (s *GeneratorSuite) TestGoMockGeneratorPrologueWithMultipleImportsSameName() {
	generator := s.getGenerator("same_name_imports.go", "Example", false, "github.com/maraino/go-mock")
...
func (s *GeneratorSuite) TestGeneratorPrologueNote() {
	generator := s.getGenerator(testFile, "Requester", false, "anything")
...
func (s *GeneratorSuite) TestVersionOnCorrectLine() {
	gen := s.getGenerator(testFile, "Requester", false, "anything")
...
func (s *GeneratorSuite) TestGeneratorWithImportSameAsLocalPackageInpkgNoCycle() {
	...
	gen := NewGenerator(iface, pkg, true, "github.com/stretchr/testify/mock")
	gen.GeneratePrologue(pkg)
...
func (s *GeneratorSuite) TestTestifyPrologueWithImportSameAsLocalPackage() {
	generator := s.getGenerator(
		"imports_same_as_package.go", "ImportsSameAsPackage", false, "github.com/stretchr/testify/mock",
	)
	expected := `package mocks
...
func (s *GeneratorSuite) TestGoMockPrologueWithImportSameAsLocalPackage() {
	generator := s.getGenerator(
		"imports_same_as_package.go", "ImportsSameAsPackage", false, "github.com/maraino/go-mock",
	)
	expected := `package mocks
...
func (s *GeneratorSuite) TestTestifyPrologueWithImportFromNestedInterface() {
	generator := s.getGenerator(
		"imports_from_nested_interface.go", "HasConflictingNestedImports", false, "github.com/stretchr/testify/mock",
	)
	expected := `package mocks
...
func (s *GeneratorSuite) TestGoMOckPrologueWithImportFromNestedInterface() {
	generator := s.getGenerator(
		"imports_from_nested_interface.go", "HasConflictingNestedImports", false, "github.com/maraino/go-mock",
	)
	expected := `package mocks
