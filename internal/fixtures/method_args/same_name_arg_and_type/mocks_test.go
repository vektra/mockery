...
// MockinterfaceA is an autogenerated mock type for the interfaceB type
type MockinterfaceA struct {
	mock.Mock
}
...
// GetData provides a mock function for the type MockinterfaceA
func (_mock *MockinterfaceA) GetData() int {
	ret := _mock.Called()
...
// MockinterfaceA_GetData_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetData'
type MockinterfaceA_GetData_Call struct {
	*mock.Call
}

// GetData is a helper method to define mock.On call
func (_e *MockinterfaceA_Expecter) GetData() *MockinterfaceA_GetData_Call {
	return &MockinterfaceA_GetData_Call{Call: _e.mock.On("GetData")}
}

func (_c *MockinterfaceA_GetData_Call) Run(run func()) *MockinterfaceA_GetData_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockinterfaceA_GetData_Call) Return(n int) *MockinterfaceA_GetData_Call {
	_c.Call.Return(n)
	return _c
}

func (_c *MockinterfaceA_GetData_Call) RunAndReturn(run func() int) *MockinterfaceA_GetData_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockinterfaceA is an autogenerated mock type for the interfaceB0 type
type MockinterfaceA struct {
	mock.Mock
}
...
// DoB0 provides a mock function for the type MockinterfaceA
func (_mock *MockinterfaceA) DoB0(interfaceB01 interfaceB0) interfaceB0 {
	ret := _mock.Called(interfaceB01)
...
// DoB0 is a helper method to define mock.On call
//   - interfaceB01
func (_e *MockinterfaceA_Expecter) DoB0(interfaceB01 interface{}) *MockinterfaceA_DoB0_Call {
	return &MockinterfaceA_DoB0_Call{Call: _e.mock.On("DoB0", interfaceB01)}
}

func (_c *MockinterfaceA_DoB0_Call) Run(run func(interfaceB01 interfaceB0)) *MockinterfaceA_DoB0_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(interfaceB0))
	})
	return _c
...
func (_c *MockinterfaceA_DoB0_Call) RunAndReturn(run func(interfaceB01 interfaceB0) interfaceB0) *MockinterfaceA_DoB0_Call {
	_c.Call.Return(run)
	return _c
}
