...
// MockRoot is an autogenerated mock type for the Stringer type
type MockRoot struct {
	mock.Mock
}
...
// String provides a mock function for the type MockRoot
func (_mock *MockRoot) String() string {
	ret := _mock.Called()
...
// MockRoot_String_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
type MockRoot_String_Call struct {
	*mock.Call
}

// String is a helper method to define mock.On call
func (_e *MockRoot_Expecter) String() *MockRoot_String_Call {
	return &MockRoot_String_Call{Call: _e.mock.On("String")}
}

func (_c *MockRoot_String_Call) Run(run func()) *MockRoot_String_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockRoot_String_Call) Return(s string) *MockRoot_String_Call {
	_c.Call.Return(s)
	return _c
}

func (_c *MockRoot_String_Call) RunAndReturn(run func() string) *MockRoot_String_Call {
	_c.Call.Return(run)
	return _c
}
