...
// NewMockGenericMultipleTypes creates a new instance of MockGenericMultipleTypes. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockGenericMultipleTypes(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockGenericMultipleTypes {
	mock := &MockGenericMultipleTypes{}
	mock.Mock.Test(t)
...
// MockGenericMultipleTypes is an autogenerated mock type for the IndexListExpr type
type MockGenericMultipleTypes struct {
	mock.Mock
}

type MockGenericMultipleTypes_Expecter struct {
	mock *mock.Mock
}

func (_m *MockGenericMultipleTypes) EXPECT() *MockGenericMultipleTypes_Expecter {
	return &MockGenericMultipleTypes_Expecter{mock: &_m.Mock}
}

// Func provides a mock function for the type MockGenericMultipleTypes
func (_mock *MockGenericMultipleTypes) Func(arg1 *int, arg2 string) bool {
	ret := _mock.Called(arg1, arg2)
...
// MockGenericMultipleTypes_Func_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Func'
type MockGenericMultipleTypes_Func_Call struct {
	*mock.Call
}
...
//   - arg1
//   - arg2
func (_e *MockGenericMultipleTypes_Expecter) Func(arg1 interface{}, arg2 interface{}) *MockGenericMultipleTypes_Func_Call {
	return &MockGenericMultipleTypes_Func_Call{Call: _e.mock.On("Func", arg1, arg2)}
}

func (_c *MockGenericMultipleTypes_Func_Call) Run(run func(arg1 *int, arg2 string)) *MockGenericMultipleTypes_Func_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGenericMultipleTypes_Func_Call) Return(b bool) *MockGenericMultipleTypes_Func_Call {
	_c.Call.Return(b)
	return _c
}

func (_c *MockGenericMultipleTypes_Func_Call) RunAndReturn(run func(arg1 *int, arg2 string) bool) *MockGenericMultipleTypes_Func_Call {
	_c.Call.Return(run)
	return _c
}
