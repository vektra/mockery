...
// Ensure, that RequesterGenericsMoq does implement test.RequesterGenerics.
// If this is not the case, regenerate this file with moq.
var _ test.RequesterGenerics[any, comparable, int, test.GetInt, io.Writer, test.GetGeneric[TSigned], int, int] = &RequesterGenericsMoq[any, comparable, int, test.GetInt, io.Writer, test.GetGeneric[TSigned], int, int]{}

// RequesterGenericsMoq is a mock implementation of test.RequesterGenerics.
//
//	func TestSomethingThatUsesRequesterGenerics(t *testing.T) {
//
//		// make and configure a mocked test.RequesterGenerics
//		mockedRequesterGenerics := &RequesterGenericsMoq{
...
//
//	}
type RequesterGenericsMoq[TAny any, TComparable comparable, TSigned constraints.Signed, TIntf test.GetInt, TExternalIntf io.Writer, TGenIntf test.GetGeneric[TSigned], TInlineType interface{ ~int | ~uint }, TInlineTypeGeneric interface {
...
func (mock *RequesterGenericsMoq[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) GenericAnonymousStructs(val struct{ Type1 TExternalIntf }) struct {
	Type2 test.GenericType[string, test.EmbeddedGet[int]]
} {
	if mock.GenericAnonymousStructsFunc == nil {
		panic("RequesterGenericsMoq.GenericAnonymousStructsFunc: method is nil but RequesterGenerics.GenericAnonymousStructs was just called")
	}
	callInfo := struct {
		Val struct{ Type1 TExternalIntf }
	}{
...
func (mock *RequesterGenericsMoq[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) GenericArguments(v1 TAny, v2 TComparable) (TSigned, TIntf) {
	if mock.GenericArgumentsFunc == nil {
		panic("RequesterGenericsMoq.GenericArgumentsFunc: method is nil but RequesterGenerics.GenericArguments was just called")
	}
	callInfo := struct {
		V1 TAny
		V2 TComparable
...
func (mock *RequesterGenericsMoq[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) GenericArgumentsCalls() []struct {
	V1 TAny
	V2 TComparable
} {
	var calls []struct {
...
func (mock *RequesterGenericsMoq[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) GenericStructs(genericType test.GenericType[TAny, TIntf]) test.GenericType[TSigned, TIntf] {
	if mock.GenericStructsFunc == nil {
		panic("RequesterGenericsMoq.GenericStructsFunc: method is nil but RequesterGenerics.GenericStructs was just called")
	}
	callInfo := struct {
		GenericType test.GenericType[TAny, TIntf]
	}{
...
func (mock *RequesterGenericsMoq[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) GenericStructsCalls() []struct {
	GenericType test.GenericType[TAny, TIntf]
} {
	var calls []struct {
		GenericType test.GenericType[TAny, TIntf]
