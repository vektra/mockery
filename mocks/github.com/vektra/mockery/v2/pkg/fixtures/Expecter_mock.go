...
func (_c *Expecter_NoArg_Call) Return(s string) *Expecter_NoArg_Call {
	_c.Call.Return(s)
	return _c
}
...
func (_mock *Expecter) NoReturn(str string)  {  _mock.Called(str)
	return 
}
...
func (_c *Expecter_Variadic_Call) Return(err error) *Expecter_Variadic_Call {
	_c.Call.Return(err)
	return _c
}
...
func (_c *Expecter_VariadicMany_Call) Return(err error) *Expecter_VariadicMany_Call {
	_c.Call.Return(err)
	return _c
}
