...
func (_mock *Fooer) Bar(f func([]int))  {  _mock.Called(f)
	return 
}
...
func (_c *Fooer_Baz_Call) Return(fn func(x string) string) *Fooer_Baz_Call {
	_c.Call.Return(fn)
	return _c
}
...
func (_c *Fooer_Foo_Call) Return(err error) *Fooer_Foo_Call {
	_c.Call.Return(err)
	return _c
}
