...
func (_c *ExpecterAndRolledVariadic_NoArg_Call) Return(s string) *ExpecterAndRolledVariadic_NoArg_Call {
	_c.Call.Return(s)
	return _c
}
...
func (_mock *ExpecterAndRolledVariadic) NoReturn(str string)  {  _mock.Called(str)
	return 
}
...
func (_c *ExpecterAndRolledVariadic_Variadic_Call) Return(err error) *ExpecterAndRolledVariadic_Variadic_Call {
	_c.Call.Return(err)
	return _c
}
...
func (_c *ExpecterAndRolledVariadic_VariadicMany_Call) Return(err error) *ExpecterAndRolledVariadic_VariadicMany_Call {
	_c.Call.Return(err)
	return _c
}
