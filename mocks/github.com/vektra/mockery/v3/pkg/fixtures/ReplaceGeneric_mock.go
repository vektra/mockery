...
func (_c *ReplaceGeneric_A_Call[TImport, TConstraint, TKeep]) Return(v TKeep) *ReplaceGeneric_A_Call[TImport, TConstraint, TKeep] {
	_c.Call.Return(v)
	return _c
}
...
func (_c *ReplaceGeneric_B_Call[TImport, TConstraint, TKeep]) Return(v TImport) *ReplaceGeneric_B_Call[TImport, TConstraint, TKeep] {
	_c.Call.Return(v)
	return _c
}
...
func (_c *ReplaceGeneric_C_Call[TImport, TConstraint, TKeep]) Return(v TConstraint) *ReplaceGeneric_C_Call[TImport, TConstraint, TKeep] {
	_c.Call.Return(v)
	return _c
}
