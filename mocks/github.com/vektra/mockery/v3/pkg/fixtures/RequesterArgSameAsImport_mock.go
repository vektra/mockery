...
func (_mock *RequesterArgSameAsImport) Get(json1 string) *json.RawMessage {  
...
//  - json1
func (_e *RequesterArgSameAsImport_Expecter) Get(json1 interface{}, ) *RequesterArgSameAsImport_Get_Call {
	return &RequesterArgSameAsImport_Get_Call{Call: _e.mock.On("Get",json1, )}
}

func (_c *RequesterArgSameAsImport_Get_Call) Run(run func(json1 string)) *RequesterArgSameAsImport_Get_Call {
...
func (_c *RequesterArgSameAsImport_Get_Call) Return(rawMessage *json.RawMessage) *RequesterArgSameAsImport_Get_Call {
	_c.Call.Return(rawMessage)
	return _c
}

func (_c *RequesterArgSameAsImport_Get_Call) RunAndReturn(run func(json1 string)*json.RawMessage) *RequesterArgSameAsImport_Get_Call {
	_c.Call.Return(run)
	return _c
}
