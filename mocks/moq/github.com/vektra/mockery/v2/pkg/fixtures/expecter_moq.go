...
func (mock *ExpecterMoq) ManyArgsReturns(str string, i int) ([]string, error) {
	if mock.ManyArgsReturnsFunc == nil {
		panic("ExpecterMoq.ManyArgsReturnsFunc: method is nil but Expecter.ManyArgsReturns was just called")
	}
	callInfo := struct {
		Str string
		I   int
...
func (mock *ExpecterMoq) ManyArgsReturnsCalls() []struct {
	Str string
	I   int
} {
	var calls []struct {
...
func (mock *ExpecterMoq) ResetManyArgsReturnsCalls() {
	mock.lockManyArgsReturns.Lock()
...
func (mock *ExpecterMoq) NoArg() string {
	if mock.NoArgFunc == nil {
		panic("ExpecterMoq.NoArgFunc: method is nil but Expecter.NoArg was just called")
	}
	callInfo := struct {
	}{}
	mock.lockNoArg.Lock()
...
func (mock *ExpecterMoq) NoArgCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *ExpecterMoq) ResetNoArgCalls() {
	mock.lockNoArg.Lock()
...
func (mock *ExpecterMoq) NoReturn(str string) {
	if mock.NoReturnFunc == nil {
		panic("ExpecterMoq.NoReturnFunc: method is nil but Expecter.NoReturn was just called")
	}
	callInfo := struct {
		Str string
	}{
...
func (mock *ExpecterMoq) NoReturnCalls() []struct {
	Str string
} {
	var calls []struct {
		Str string
...
func (mock *ExpecterMoq) ResetNoReturnCalls() {
	mock.lockNoReturn.Lock()
...
func (mock *ExpecterMoq) Variadic(ints ...int) error {
	if mock.VariadicFunc == nil {
		panic("ExpecterMoq.VariadicFunc: method is nil but Expecter.Variadic was just called")
	}
	callInfo := struct {
		Ints []int
	}{
...
func (mock *ExpecterMoq) VariadicCalls() []struct {
	Ints []int
} {
	var calls []struct {
		Ints []int
...
func (mock *ExpecterMoq) ResetVariadicCalls() {
	mock.lockVariadic.Lock()
...
func (mock *ExpecterMoq) VariadicMany(i int, a string, intfs ...interface{}) error {
	if mock.VariadicManyFunc == nil {
		panic("ExpecterMoq.VariadicManyFunc: method is nil but Expecter.VariadicMany was just called")
	}
	callInfo := struct {
		I     int
		A     string
...
func (mock *ExpecterMoq) VariadicManyCalls() []struct {
	I     int
	A     string
	Intfs []interface{}
} {
...
func (mock *ExpecterMoq) ResetVariadicManyCalls() {
	mock.lockVariadicMany.Lock()
...
func (mock *ExpecterMoq) ResetCalls() {
	mock.lockManyArgsReturns.Lock()
	mock.calls.ManyArgsReturns = nil
	mock.lockManyArgsReturns.Unlock()
