...
// A calls AFunc.
func (mock *ExampleMoq) A() http.Flusher {
	if mock.AFunc == nil {
		panic("ExampleMoq.AFunc: method is nil but Example.A was just called")
	}
	callInfo := struct {
	}{}
	mock.lockA.Lock()
...
func (mock *ExampleMoq) ACalls() []struct {
} {
	var calls []struct {
	}
	mock.lockA.RLock()
...
func (mock *ExampleMoq) ResetACalls() {
	mock.lockA.Lock()
	mock.calls.A = nil
	mock.lockA.Unlock()
}
...
// B calls BFunc.
func (mock *ExampleMoq) B(fixtureshttp string) my_http.MyStruct {
	if mock.BFunc == nil {
		panic("ExampleMoq.BFunc: method is nil but Example.B was just called")
	}
	callInfo := struct {
		Fixtureshttp string
	}{
...
func (mock *ExampleMoq) BCalls() []struct {
	Fixtureshttp string
} {
	var calls []struct {
		Fixtureshttp string
...
func (mock *ExampleMoq) ResetBCalls() {
	mock.lockB.Lock()
	mock.calls.B = nil
	mock.lockB.Unlock()
}
...
func (mock *ExampleMoq) ResetCalls() {
	mock.lockA.Lock()
	mock.calls.A = nil
	mock.lockA.Unlock()
