...
func (s *GeneratorSuite) TestGenericGenerator() {
	expected := `// Generic is an autogenerated mock type for the Generic type
type Generic[T test.Constraint] struct {
	mock.Mock
}

// Get provides a mock function with given fields:
func (_m *Generic[T]) Get() T {
	ret := _m.Called()
...
// NewGeneric creates a new instance of Generic. It also registers a cleanup function to assert the mocks expectations.
func NewGeneric[T test.Constraint](t testing.TB) *Generic[T] {
	mock := &Generic[T]{}
...
`
	s.checkGeneration("generic.go", "Generic", false, "", expected)
}

func (s *GeneratorSuite) TestGenericInPkgGenerator() {
	expected := `// MockGeneric is an autogenerated mock type for the Generic type
type MockGeneric[T Constraint] struct {
	mock.Mock
}

// Get provides a mock function with given fields:
func (_m *MockGeneric[T]) Get() T {
	ret := _m.Called()
...
// NewMockGeneric creates a new instance of MockGeneric. It also registers a cleanup function to assert the mocks expectations.
func NewMockGeneric[T Constraint](t testing.TB) *MockGeneric[T] {
	mock := &MockGeneric[T]{}
...
`
	s.checkGeneration("generic.go", "Generic", true, "", expected)
}

func (s *GeneratorSuite) TestGenericAnyGenerator() {
	expected := `// GenericAny is an autogenerated mock type for the GenericAny type
type GenericAny[T any] struct {
	mock.Mock
}

// Get provides a mock function with given fields:
func (_m *GenericAny[T]) Get() T {
	ret := _m.Called()
...
// NewGenericAny creates a new instance of GenericAny. It also registers a cleanup function to assert the mocks expectations.
func NewGenericAny[T any](t testing.TB) *GenericAny[T] {
	mock := &GenericAny[T]{}
...
`
	s.checkGeneration("generic.go", "GenericAny", false, "", expected)
}

func (s *GeneratorSuite) TestGenericComparableGenerator() {
	expected := `// GenericComparable is an autogenerated mock type for the GenericComparable type
type GenericComparable[T comparable] struct {
	mock.Mock
}

// Get provides a mock function with given fields:
func (_m *GenericComparable[T]) Get() T {
	ret := _m.Called()
...
// NewGenericComparable creates a new instance of GenericComparable. It also registers a cleanup function to assert the mocks expectations.
func NewGenericComparable[T comparable](t testing.TB) *GenericComparable[T] {
	mock := &GenericComparable[T]{}
...
`
	s.checkGeneration("generic.go", "GenericComparable", false, "", expected)
}

func (s *GeneratorSuite) TestEmbeddedGenericGenerator() {
	expected := `// Embedded is an autogenerated mock type for the Embedded type
type Embedded struct {
	mock.Mock
}

// Get provides a mock function with given fields:
func (_m *Embedded) Get() int {
	ret := _m.Called()
...
// NewEmbedded creates a new instance of Embedded. It also registers a cleanup function to assert the mocks expectations.
...
`
	s.checkGeneration("generic.go", "Embedded", false, "", expected)
}
...
func (s *GeneratorSuite) TestGeneratorExpecterComplete() {
	expectedBytes, err := ioutil.ReadFile(getMocksPath("ExpecterTestWithExpecter.go"))
	require.NoError(s.T(), err)
	expected := string(expectedBytes)
	expected = expected[strings.Index(expected, "// ExpecterTestWithExpecter is"):]

	cfg := config.Config{
		StructName:     "ExpecterTestWithExpecter",
		WithExpecter:   true,
		UnrollVariadic: true,
	}
	s.checkGenerationWithConfig(testFile, "ExpecterTest", cfg, expected)
}
...
func (s *GeneratorSuite) TestGeneratorExpecterFailsWithoutUnrolledVariadic() {
	...
	gen := s.getGeneratorWithConfig(testFile, "ExpecterTest", cfg)
...
func NewRequester3(t NewRequester3T) *Requester3 {
	mock := &Requester3{}
	mock.Mock.Test(t)
...
func NewRequester4(t NewRequester4T) *Requester4 {
	mock := &Requester4{}
	mock.Mock.Test(t)
...
func newMockRequester_unexported(t newMockRequester_unexportedT) *mockRequester_unexported {
...
func NewRequesterReturnElided(t NewRequesterReturnElidedT) *RequesterReturnElided {
...
func NewMapFunc(t NewMapFuncT) *MapFunc {
	mock := &MapFunc{}
	mock.Mock.Test(t)
...
func NewMockUsesOtherPkgIface(t NewMockUsesOtherPkgIfaceT) *MockUsesOtherPkgIface {
...
func NewRequester2OverrideName(t NewRequester2OverrideNameT) *Requester2OverrideName {
