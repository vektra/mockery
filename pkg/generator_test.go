...
func (_m *RequesterPtr_Get) Return(_a0 *string, _a1 error) *RequesterPtr_Get {
	return &RequesterPtr_Get{Call: _m.Call.Return(_a0, _a1)}
}
...
func (_m *RequesterPtr) OnGetMatch(matchers ...interface{}) *RequesterPtr_Get {
...
type Requester2OverrideName_Get struct {
	*mock.Call
}

func (_m *Requester2OverrideName_Get) Return(_a0 error) *Requester2OverrideName_Get {
	return &Requester2OverrideName_Get{Call: _m.Call.Return(_a0)}
}

func (_m *Requester2OverrideName) OnGet(path string) *Requester2OverrideName_Get {
	c := _m.On("Get", path)
	return &Requester2OverrideName_Get{Call: c}
}

func (_m *Requester2OverrideName) OnGetMatch(matchers ...interface{}) *Requester2OverrideName_Get {
	c := _m.On("Get", matchers...)
	return &Requester2OverrideName_Get{Call: c}
}
...
type RequesterGenerics_GenericAnonymousStructs[TAny interface{}, TComparable comparable, TSigned constraints.Signed, TIntf test.GetInt, TExternalIntf io.Writer, TGenIntf test.GetGeneric[TSigned], TInlineType interface{ ~int | ~uint }, TInlineTypeGeneric interface {
	~int | test.GenericType[int, test.GetInt]
	comparable
}] struct {
	*mock.Call
...
func (_m *RequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) Return(_a0 struct {
	Type2 test.GenericType[string, test.EmbeddedGet[int]]
}) *RequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	return &RequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: _m.Call.Return(_a0)}
}

func (_m *RequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericAnonymousStructs(_a0 struct{ Type1 TExternalIntf }) *RequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericAnonymousStructs", _a0)
	return &RequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}

func (_m *RequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericAnonymousStructsMatch(matchers ...interface{}) *RequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericAnonymousStructs", matchers...)
	return &RequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}
...
type RequesterGenerics_GenericArguments[TAny interface{}, TComparable comparable, TSigned constraints.Signed, TIntf test.GetInt, TExternalIntf io.Writer, TGenIntf test.GetGeneric[TSigned], TInlineType interface{ ~int | ~uint }, TInlineTypeGeneric interface {
	~int | test.GenericType[int, test.GetInt]
	comparable
}] struct {
	*mock.Call
...
func (_m *RequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) Return(_a0 TSigned, _a1 TIntf) *RequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	return &RequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *RequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericArguments(_a0 TAny, _a1 TComparable) *RequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericArguments", _a0, _a1)
	return &RequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}

func (_m *RequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericArgumentsMatch(matchers ...interface{}) *RequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericArguments", matchers...)
	return &RequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}
...
type RequesterGenerics_GenericStructs[TAny interface{}, TComparable comparable, TSigned constraints.Signed, TIntf test.GetInt, TExternalIntf io.Writer, TGenIntf test.GetGeneric[TSigned], TInlineType interface{ ~int | ~uint }, TInlineTypeGeneric interface {
	~int | test.GenericType[int, test.GetInt]
	comparable
}] struct {
	*mock.Call
...
func (_m *RequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) Return(_a0 test.GenericType[TSigned, TIntf]) *RequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	return &RequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: _m.Call.Return(_a0)}
}

func (_m *RequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericStructs(_a0 test.GenericType[TAny, TIntf]) *RequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericStructs", _a0)
	return &RequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}

func (_m *RequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericStructsMatch(matchers ...interface{}) *RequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericStructs", matchers...)
	return &RequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}
...
type MockRequesterGenerics_GenericAnonymousStructs[TAny interface{}, TComparable comparable, TSigned constraints.Signed, TIntf GetInt, TExternalIntf io.Writer, TGenIntf GetGeneric[TSigned], TInlineType interface{ ~int | ~uint }, TInlineTypeGeneric interface {
	~int | GenericType[int, GetInt]
	comparable
}] struct {
	*mock.Call
...
func (_m *MockRequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) Return(_a0 struct {
	Type2 GenericType[string, EmbeddedGet[int]]
}) *MockRequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	return &MockRequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: _m.Call.Return(_a0)}
}

func (_m *MockRequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericAnonymousStructs(_a0 struct{ Type1 TExternalIntf }) *MockRequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericAnonymousStructs", _a0)
	return &MockRequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}

func (_m *MockRequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericAnonymousStructsMatch(matchers ...interface{}) *MockRequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericAnonymousStructs", matchers...)
	return &MockRequesterGenerics_GenericAnonymousStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}
...
type MockRequesterGenerics_GenericArguments[TAny interface{}, TComparable comparable, TSigned constraints.Signed, TIntf GetInt, TExternalIntf io.Writer, TGenIntf GetGeneric[TSigned], TInlineType interface{ ~int | ~uint }, TInlineTypeGeneric interface {
	~int | GenericType[int, GetInt]
	comparable
}] struct {
	*mock.Call
...
func (_m *MockRequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) Return(_a0 TSigned, _a1 TIntf) *MockRequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	return &MockRequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *MockRequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericArguments(_a0 TAny, _a1 TComparable) *MockRequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericArguments", _a0, _a1)
	return &MockRequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}

func (_m *MockRequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericArgumentsMatch(matchers ...interface{}) *MockRequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericArguments", matchers...)
	return &MockRequesterGenerics_GenericArguments[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}
...
type MockRequesterGenerics_GenericStructs[TAny interface{}, TComparable comparable, TSigned constraints.Signed, TIntf GetInt, TExternalIntf io.Writer, TGenIntf GetGeneric[TSigned], TInlineType interface{ ~int | ~uint }, TInlineTypeGeneric interface {
	~int | GenericType[int, GetInt]
	comparable
}] struct {
	*mock.Call
...
func (_m *MockRequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) Return(_a0 GenericType[TSigned, TIntf]) *MockRequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	return &MockRequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: _m.Call.Return(_a0)}
}

func (_m *MockRequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericStructs(_a0 GenericType[TAny, TIntf]) *MockRequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericStructs", _a0)
	return &MockRequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}

func (_m *MockRequesterGenerics[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]) OnGenericStructsMatch(matchers ...interface{}) *MockRequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric] {
	c := _m.On("GenericStructs", matchers...)
	return &MockRequesterGenerics_GenericStructs[TAny, TComparable, TSigned, TIntf, TExternalIntf, TGenIntf, TInlineType, TInlineTypeGeneric]{Call: c}
}
