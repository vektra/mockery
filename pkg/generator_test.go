...
func (s *GeneratorSuite) TestGeneratorWithNoArgReturnProviderFunction() {
	expected := `// Requester is an autogenerated mock type for the Requester type
type Requester struct {
	mock.Mock
}
...
func (_m *Requester) Get(path string) (string, error) {
	...
	if rf, ok := ret.Get(0).(func(string) string); ok {
		r0 = rf(path)
	} else if rf, ok := ret.Get(0).(func() string); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	if rf, ok := ret.Get(1).(func(string) error); ok {
		r1 = rf(path)
	} else if rf, ok := ret.Get(1).(func() error); ok {
		r1 = rf()
	} else {
		r1 = ret.Error(1)
	}
...
func (s *GeneratorSuite) TestGeneratorNoArgumentsNoArgReturnProviderFunction() {
	expected := `// Requester3 is an autogenerated mock type for the Requester3 type
type Requester3 struct {
	mock.Mock
}
...
`
	...
	s.checkGenerationWithConfig("requester3.go", "Requester3", cfg, expected)
}
