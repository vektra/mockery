...
func (_m *Requester2) On_Get(path string, r_a0 error) *mock.Call {
	return _m.Mock.On("Get", path).Return(r_a0)
}
...
func (_m *mockRequester_unexported) On_Get() *mock.Call {
	return _m.Mock.On("Get").Return()
}
...
func (_m *RequesterSlice) On_Get(path string, r_a0 []string, r_a1 error) *mock.Call {
	return _m.Mock.On("Get", path).Return(r_a0, r_a1)
}
...
func (_m *RequesterArgSameAsNamedImport) On_Get(_a0 string, r_a0 *json.RawMessage) *mock.Call {
	return _m.Mock.On("Get", _a0).Return(r_a0)
}
...
func (_m *RequesterReturnElided) On_Get(path string, ra int, rb int, rc int, rerr error) *mock.Call {
	return _m.Mock.On("Get", path).Return(ra, rb, rc, rerr)
}
...
func (_m *MockUsesOtherPkgIface) On_DoSomethingElse(obj Sibling) *mock.Call {
	return _m.Mock.On("DoSomethingElse", obj).Return()
}
...
func (_m *Requester2OverrideName) On_Get(path string, r_a0 error) *mock.Call {
	return _m.Mock.On("Get", path).Return(r_a0)
}
