...
func (s *GeneratorSuite) getInterfaceFromFile(
	interfacePath, interfaceName string,
) *Interface {
...
func (s *GeneratorSuite) TestGeneratorExpecterComplete() {
	expectedBytes, err := ioutil.ReadFile(filepath.Join(fixturePath, "mocks", "expecter.go"))
	s.NoError(err)
