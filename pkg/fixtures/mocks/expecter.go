...
// NewExpecterTest creates a new instance of ExpecterTest. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
