...
func (_m *EmptyReturnMock) NoArgs() {
	_m.Called()
}
...
func (_m *EmptyReturnMock) WithArgs(a int, b string) {
	_m.Called(a, b)
}
...
func (_c *EmptyReturnMock_WithArgs_Call) RunAndReturn(run func(int, string)) *EmptyReturnMock_WithArgs_Call {
	_c.Run(run)
	return _c
}
