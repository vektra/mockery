...
func (c *Config) ShouldGenerateInterface(
	ctx context.Context,
	packageName, interfaceName string,
	...
	shouldSkipGenerated := !pkgConfig.IncludeAutoGenerated
	if shouldSkipGenerated && isAutoGenerated {
		return false, nil
	}
